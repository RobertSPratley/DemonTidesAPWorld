...
from . import options as demontides_options  # rename due to a name conflict with World.options
...
class DemonTidesWorld(World):
    ...
    # (Note: options.py has been imported as "demontides_options" at the top of this file to avoid a name conflict)
    options_dataclass = demontides_options.DemonTidesOptions
    options: demontides_options.DemonTidesOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
